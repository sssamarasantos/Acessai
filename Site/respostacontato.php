...
ini_set("display_errors", 0);
	...
	//carrega a tabela
	$Matriz=$conexao->prepare("select* FROM CONTATO");

	echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		<b style='font-family:Megrim; font-size:40px; margin-left:50px'> Contatos realizados no site: </b><br><br>";
	$Matriz->execute();
	...
	echo "<td><b>&nbsp Msg do Contato &nbsp</td>";
	echo "<td><b>&nbsp Resposta do Contato &nbsp </b></td>";
	echo "</tr>";
	...
	echo "<td>&nbsp".$respContato."&nbsp</td>";
	echo "</tr>";
	}
	...
	else
	{
		...
		<div class="formulario">
			<form name="form1" action="respostacontato.php?valor=enviado" method="POST">
				...
				<div class="form-group">
					...
					<textarea class="form-control" placeholder="Preencha a resposta..." name="resp_contato" rows="8" cols="40"></textarea>
		...
		if ($_SESSION['controleResp']=='localizado') 
		{
			...
			<b>░&nbsp&nbsp Dados do Contato </b><br><br>";
