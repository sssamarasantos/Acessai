<!--// TELA ADMINISTRADOR - ALTERAR DADOS -->
<!DOCTYPE html>
<html>
<head>
	<title> Administrador Info | Acessaí </title>
...
//ini_set("display_errors", 0);
	...
	echo "<div class='imagem'>
			<img src='imag/pcfundo.png' width=230px; height=230p;>
		  </div>
		  
		  <div class='Infos'> 
		░&nbsp&nbsp  Dados do Administrador <br><br>
		&nbsp&nbsp	Nome: ".$_SESSION['nomeAdm']."<br>
		&nbsp&nbsp	Usuário: ".$_SESSION['emailAdm']."<br><br>
		  </div>";
...
<div class="formulario">
	<form name="form1" action="alteraradm.php?valor=enviado" method="POST">
		<div class="form-group">
			...
			<input type="text" size="45" class="form-control" id="nome_cadastro_professor" placeholder="Preencha seu nome" name="nome_cadastro">
		</div>
		<div class="form-group">
			<label for="Email"> Alterar Usuário [E-mail] </label>
			<input type="text" class="form-control" id="nome_cadastro" placeholder="Preencha seu e-mail" name="usuario_cadastro">
		</div>
		<div class="form-group">
			<label for="Senha"> Senha </label>
			<input type="password" class="form-control" placeholder="Preencha sua senha" name="senha_cadastro" maxlength="8" required>
		</div>
		<div class="form-group">
			<label for="SenhaConf"> Confirmar Senha </label>
			<input type="password" class="form-control" placeholder="Confirme sua senha" name="senha_confirma" maxlength="8" required>
		</div>
