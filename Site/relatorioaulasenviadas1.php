...
echo "<br><br><br><b style='font-family:Megrim; font-size:40px; margin-left:100px'> Disciplinas que ministra </b><br><br>";
$Matriz->execute();
...
<div class="formulario">
	<form class="was-validated" action="relatorioaulasenviadas1.php?valor=enviado" method="POST">
...
if ($_SESSION['controled']=='localizado') 
{
	echo "<div class='infos'> Disciplina selecionada
	<BR> &nbsp&nbsp&nbsp <b>".$_SESSION['nomeDisc'].'</b></div><br>'.'<br>';
